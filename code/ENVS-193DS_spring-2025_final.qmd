...
In this data set, 0s and 1s represent absent and present, respectively. For example, if a Tree Martin was present, there would be a 1 in that column, and if there were none present, there would be a 0 in that column.

## b. Purpose of study

In the context of this study, Swift Parrots are the main species of interest, as they are on the brink of extinction, and the next boxes are going to be used in theory to help their population recover. The other two species, the Common Starling and the Tree Martin are potential competitors that may interfere with the the nest boxes.

## c. Difference in "seasons"

The two different "seasons" that were compared in this study were the years 2016 and 2019. 2016 was the year that the nest boxes were initially deployed, and the 2019 was 3 years after that event in 2019, a tree flowering event triggered a second Swift Parrot breeding event at the study site.
...
**Figure 1. Probability of Swift Parrot nest box occupancy is higher in 2016 than 2019.**
Data from Stojanovic Dejan et al. (2021) 'Do nest boxes breed the target species or its competitors? A case study of a critically endangered bird.' Points represent individual oberservations of the presence or absence of a swift parrot in a nesting box. Ribbons represent the 95% confidence interval. Colors represent the season (Purple = 2016, Blue = 2019).
...
Even though I did not have many observations in my intial exploratory visualization, I could see from the bar graph that the Aerobic workout lead to the highest average hours slept, and from my line graph, an increased distance in yards also lead to the highest amount of hours slept. I noticed similar patterns in my final affective visualization, where the Aerobic and Racing categories of swimming workouts had the highest means, both with an average of 7.8 hours. All of my data matched my predictions, that longer, more intense workouts lead me to sleep a greater amount of hours at night.

One piece of feedback that I got during week 9 workshop was to include the individual data observations in my visualization. Before, I had just had a swimmer that I used to represent the mean in each category, by showing them at different places within a lane that represented a different category. I decided to add little bubbles to each of the lanes, which represent the individual data points, and I think adding this component really helped to make the visualization more effective.
