...
In this data set, 0s and 1s represent absence and presence, respectively. For example, if a Tree Martin was present, there would be a 1 in that column, and if there were none present, there would be a 0 in that column.
